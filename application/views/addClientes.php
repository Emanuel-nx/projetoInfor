      ...
      <div class="row">
        ...
        <form action="<?=base_url('clientes/salvar')?>" name="form_add" data-toggle="validator"method="post">
          ...
          <div class="row">
            <div class="col-md-8">
              <label>Nome</label>*
              <input type="text" name="nome" value="" class="form-control" placeholder="Campo Obrigatorio!" required>
            </div>
          ...
          <div class="row">
	            <div class="col-md-2">
	              ...
	              <input type="text" name="endereco" value="" class="form-control" placeholder="">
	            </div>
		  ...
		  <div class="row">
		      	<div class="col-md-2">
		            <label>Cidade</label>
		             <input type="text" name="cidade" value="" class="form-control" placeholder="">
		        </div>

            <div class="row">
            <div class="col-md-2">
                <label>Estado</label>
                 <input type="text" name="estado" value="" class="form-control" placeholder="">
            </div>

            <div class="row">
            <div class="col-md-2">
                <label>Renda</label>
                 <input type="text" name="renda" value="" class="form-control" placeholder="R$ ">
            </div>
